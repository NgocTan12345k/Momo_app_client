          ...
          <div className="banner__content container">
            <div className="banner__content-detail ">
              ...
              <p>
                ...
                tiền cùng hàng triệu người, giúp đỡ các hoàn cảnh khó khăn trên
                khắp cả nước.
              </p>
                ...
                posts.slice(0, 6).map((item, index) => {
                  return (
                    <div
                      ...
                      key={index + 1}
                    >
                      <CardComponent item={item} index={index} count={count} />
                    </div>
                  );
                })}
            </div>
                  ...
                  <div className="advertisement__detail">
                    ...
                    <div className="advertisement__detail-description">
                      ...
                      <p>
                        ...
                        triệu nhà hảo tâm khác của “Trái tim MoMo” giúp đỡ những
                        mảnh đời khó khăn.
                      </p>
                    </div>
                  </div>
              ...
              <div className="home__question-content">
                <Accordion flush>
                  <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                      Trái tim MoMo là tính năng gây quỹ từ thiện của MoMo. Các
                      dự án được đăng tải trong Trái Tim MoMo đều là những dự án
                      đã được lựa chọn cẩn trọng bởi đội ngũ MoMo, và được bảo
                      trợ bởi các tổ chức uy tín.
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                      MoMo hoàn toàn không thu lợi nhuận từ việc gây quỹ. Ngoại
                      trừ phí chuyển khoản ngân hàng, 100% số tiền của người
                      dùng được chuyển tới cho các tổ chức bảo trợ.
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="2">
                    <Accordion.Header>
                      Sau bao lâu từ khi quyên góp, tiền sẽ được chuyển đến tay
                      hoàn cảnh cảnh?
                    </Accordion.Header>
                    <Accordion.Body>
                  ...
                  <Accordion.Item eventKey="3">
                    ...
                    <Accordion.Body>
                      ...
                      phủ, Doanh nghiệp xã hội hoặc một cơ quan nhà nước có chức
                      năng tiếp nhận tài trợ.
                    </Accordion.Body>
                  </Accordion.Item>
